...
import { Clock, Mail, MapPin, Share, User,IndianRupee } from 'lucide-react'
  ...
  return business?.name&&(
    <div className='md:flex gap-4 items-center'>
      ...
      <div className='flex flex-col gap-5 items-end'>
        ...
        <h2 className='flex gap-2 text-xl text-gray-500'><IndianRupee/>Price : {business.price}120/h</h2>
